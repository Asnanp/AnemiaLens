...
export async function sendEmailReport(email: string, shareText: string, triageLabel: string, hb: number | null, risk: number): Promise<{ status: string; message: string }> {
