import CJS_COMPAT_NODE_URL_sn160xfe7qh from 'node:url';
import CJS_COMPAT_NODE_PATH_sn160xfe7qh from 'node:path';
import CJS_COMPAT_NODE_MODULE_sn160xfe7qh from "node:module";

var __filename = CJS_COMPAT_NODE_URL_sn160xfe7qh.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_sn160xfe7qh.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_sn160xfe7qh.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-V7TSHZNP.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-QCZ4HLLR.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-NQGMA7O7.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-FK36V65H.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
