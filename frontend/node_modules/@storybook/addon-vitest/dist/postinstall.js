import CJS_COMPAT_NODE_URL_ffojgd99l5f from 'node:url';
import CJS_COMPAT_NODE_PATH_ffojgd99l5f from 'node:path';
import CJS_COMPAT_NODE_MODULE_ffojgd99l5f from "node:module";

var __filename = CJS_COMPAT_NODE_URL_ffojgd99l5f.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_ffojgd99l5f.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_ffojgd99l5f.createRequire(import.meta.url);
...
import {
  any
} from "./_node-chunks/chunk-A7KED4FS.js";
import {
  DOCUMENTATION_LINK
} from "./_node-chunks/chunk-TL7FGSQL.js";
import {
  require_dist
} from "./_node-chunks/chunk-MEY7IL6U.js";
import {
  dirname,
  normalize,
  relative,
  resolve
} from "./_node-chunks/chunk-JPB2VFHE.js";
import {
  require_compare,
  require_constants,
  require_debug,
  ...
  require_re,
  require_semver
} from "./_node-chunks/chunk-PAZCZDEQ.js";
import {
  __commonJS,
  __toESM
} from "./_node-chunks/chunk-OJNHJMCL.js";
...
async function getTemplatePath(name) {
  switch (name) {
    case "vitest.config.template":
      return import("./_node-chunks/vitest.config-BSZ7A3YY.js");
    case "vitest.config.4.template":
      return import("./_node-chunks/vitest.config.4-AZGM6I6A.js");
    case "vitest.config.3.2.template":
      return import("./_node-chunks/vitest.config.3.2-RJV5Q2DP.js");
    case "vitest.workspace.template":
      return import("./_node-chunks/vitest.workspace-34HUMUDG.js");
    default:
